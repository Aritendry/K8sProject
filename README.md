...
1. **Domaine** : `echo "<IP_NOEUD> www.ecommerce.lcl" >> /etc/hosts`
2. **Cluster** : installer Nginx Ingress Controller + ArgoCD.
3. **ArgoCD** : lier le repo GitHub et créer l'Application (path `./k8s`) :
   ```bash
